...
export const PrintingDetailForm = ({list,data,updateData}) => {
  ...
  const vechicleOptions = [
    ...
    { label: "Brochures/Pamphlets", value: "Brochures/Pamphlets" },
  ...
  useEffect(() => {
    ...
    params = {
      ...
      unit: count,
      claimAmount: amount,
      field: {label: 'Printing', value: vechicleType?.value},
      billFile: uploadData,
  ...
  return (
    <>
      <Grid item className='crm-sd-claims-expenses-form-item' xs={12} md={4}>
        <Typography component="h4" className='crm-sd-claims-expenses-form-label'>Printing</Typography>
        <FormSelect
          theme="dark"
          fontTheme="lg"
      ...
      <Grid item className='crm-sd-claims-expenses-form-item' xs={12} md={4}>
        <Typography component="h4" className='crm-sd-claims-expenses-form-label'>Count</Typography>
        <TextField
          autoComplete="off"
