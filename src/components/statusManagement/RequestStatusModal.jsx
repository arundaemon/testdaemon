...
export default function RequestStatusModal(props) {
    let { openPopup, recordForEdit, allStageList, handleCloseEditPopup, handleOnChange, handleSelectStageName, edit } = props;
            ...
            <Fade in={openPopup}>
                <Box className={classes.modalPaper + " modal-box modal-md"} id="transition-modal-title">
                    ...
                    <Box className="modal-content text-left">
                        ...
                        <Grid container mb={2} spacing={2} >
                            <Grid item xs={12} sm={6} md={6} lg={6} >
                                <Typography className="text-small label" variant="subtitle2" mt={1}> Status Name </Typography>
                        ...
                        <Box className="modal-footer text-right" >
                            ...
                            <Button onClick={edit} color="primary" autoFocus className={classes.containedButton + " report_form_ui_btn submit"} variant="contained"> Submit </Button>
                        </Box>
                    </Box>
                </Box>
            </Fade>
