...
const RefurbishLeads = () => {
    ...
    const handleTransfer = () => {
        ...
        navigate('/authorised/refurbish-leads')
        setSelectedUser('')
    }
    ...
    const fetchCrmLeadAssignmentList = (roleList) => {
        ...
        if (filtersApplied?.length === 0 && (applyFilter?.length === 0 || !applyFilter)) {
            ...
            let queryData = { search, itemsPerPage, pageNo: (pageNo - 1), filtersApplied, refurbishFlag: true, childRoleNames: roleList, ...sortObj }
                ...
                <div className="tableCardContainer">
                    <Paper>
                        ...
                        <div className={classes.filterSection}>
                            ...
                            {/* <div align="right" style={{marginLeft: '99rem'}}>
                                <Button className={classes.submitBtn} onClick={() => handleRefurbishModal()}>Refurbish</Button>

                                </div>
                                <RefurbishLeadsModal selectedLeads={selectedLeads} setCheckedLeads={setCheckedLeads} setSelectedLeads={setSelectedLeads}refurbishModal={refurbishModal} setRefurbishModal={setRefurbishModal}/> */}
                            {/* <span>
                                    <div className="filterContainer mt-1">
                                        <LeadFilterMweb />
                                    </div>
