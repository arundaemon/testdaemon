...
import { ImplementationApprovedTableList } from "../../components/Implementation/ImplementationApproved";
const style = {
  position: "absolute",
  top: "50%",
  left: "50%",
...
const SiteApprovedList = () => {
  ...
  const getImplementationList = async (childRoleNames) => {
    try {
      ...
      let res = await getImplementationByCondition(params);
      ...
      <div className="tableCardContainer">
        ...
        {!isLoading ? (
          implementationData.length ? (
            <>
              <ImplementationApprovedTableList
...
export default SiteApprovedList;
