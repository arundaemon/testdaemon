...
import { UserProfileName, assignedEngineerType, fieldTab } from "../../constants/general";
const style = {
  position: "absolute",
  top: "50%",
  left: "50%",
...
const HardwareSiteSurveyList = () => {
  ...
  const getImplementationList = async (childRoleNames) => {
    try {
      ...
      // let res = await fetchImplementationList(params);                    //@r
  ...
  const assignEngineer = async () => {
    ...
    try {
      let params = {
        ...
        type: assignedEngineerType?.SSR,
        status: assignedEngineerType?.isSSREngineerStatus,
        ssrEngineerAssigned: true,
        stage: 'Site Survey'
      };
          ...
          implementationData.length ? (
            <>
              <ImplementationTableList
                ...
                implementationType={fieldTab?.SSR}
...
export default HardwareSiteSurveyList;
