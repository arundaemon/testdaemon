    ...
    <Box>
      {
        ...
        <NoDataComponent message={'No Product History Available.'} className="crm-school-lead-no-data"  />
        :
        (
          <TableContainer component={Paper}>
            <Table sx={{ minWidth: !isMobile ? 700 : '100%' }} aria-label="customized table" className="crm-table-container crm-school-detail-accordion-table">
              <TableHead>
                <TableRow>
