...
export default function ReasonForDisqualificationTable(props) {
            ...
            <Table aria-label="simple table" className="custom-table datasets-table">
                <TableHead>
                    <TableRow className="cm_table_head">
                        ...
                        <TableCell> <div className='tableHeadCell'> Reason For Disqualification </div></TableCell>
                    ...
                    {list && list.length > 0 &&
                        list.map((row, i) => (
                            ...
                            >
                                ...
                                <TableCell>{row?.reasonForDisqualification}</TableCell>
