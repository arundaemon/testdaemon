...
export default function CrmFieldMasterTable(props) {
      ...
      <Table aria-label="simple table" className="custom-table datasets-table">
        <TableHead>
          <TableRow className="cm_table_head">
            ...
            <TableCell> <div className='tableHeadCell'> Field Name </div></TableCell>
            <TableCell> <div className='tableHeadCell'> Field Type </div></TableCell>
